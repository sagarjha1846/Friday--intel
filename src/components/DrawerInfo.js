    ...
    <section className="help">
      <div className="help2">
        ...
        <div className="parent">
          ...
          <div className="div2">
            ...
            <p>
              ...
              <li>
                {' '}
                A site must be a full domain address <br />
        ...
        <p>
          ...
          linked <br />
          to the searched keyword. The keyword or source of the keyword could{' '}
          <br />
          be used to generate a list of analysis results. <br />
          The Monography of Friday Intel button displays a list of indicators
          that <br />
