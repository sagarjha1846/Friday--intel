      ...
      <div className="help2">
        ...
        <div className='parent'>
          ...
          <div className='div2'>
            <h4>Description</h4>
            <hr />
            <p>The search results are exact matches <br />
             to the keywords in “ ”</p>
            <hr />
...
<hr />
            ...
            <p>Search result in filtered URL</p>
              <li>
...
<p>The purpose of indicator search is to extract information that is linked <br />
to the searched keyword. The keyword or source of the keyword could <br />
be used to generate a list of analysis results. <br />

The Monography of Friday Intel button displays a list of indicators that <br />
you can use. To search, click an indicator and enter an exact keyword <br />
